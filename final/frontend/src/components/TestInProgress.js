  ...
  return !isActive ? (
    ...
    <div>
      <main className="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <strong className={`${benchmarksCompleted.count === benchmarkNames.length ? "collapse" : ""}`}>Test in Progress</strong>
        <strong className={`${benchmarksCompleted.count === benchmarkNames.length ? "" : "collapse"}`}>Test Completed</strong>
        </div>
